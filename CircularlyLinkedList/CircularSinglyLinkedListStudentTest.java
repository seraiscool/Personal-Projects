...
public class CircularSinglyLinkedListStudentTest {
    ...
    @Test(timeout = TIMEOUT)
    public void testLastOccurrenceBack() {
        ...
        list.addAtIndex(3, "2a");   // 0a, 2a, 1a, 2a
        list.addAtIndex(4, "3a");   // 0a, 2a, 1a, 2a, 3a
        list.addAtIndex(5, temp);   // 0a, 2a, 1a, 2a, 3a, 4a
        assertEquals(6, list.size());

        assertSame(temp, list.removeLastOccurrence("4a")); // 0a, 2a, 1a, 2a, 3a
        assertEquals(5, list.size());
    ...
    @Test(timeout = TIMEOUT)
    public void testLastOccurrenceSingleEntry() {
        String temp = new String("0a");

        list.addAtIndex(0, temp);   // 0a
        assertEquals(1, list.size());

        assertSame(temp, list.removeLastOccurrence("0a")); // blank
        assertEquals(0, list.size());
